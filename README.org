...
*** Ordering principle (=op=)
    ...
    Both  such formulas  are unsatisfiable,  but the  short refutation
    known in  literature for  ordering principle works  for =--knuth2=
    variant, while it does not for =--knuth3= variant.
