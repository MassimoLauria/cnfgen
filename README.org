...
* CNF formula generator and tools
  ...
  This repository provides the python scripts
  ...
  : cnfgen.py -o <output_file> [transformation options] <formula_type> <formula_parameters>

  To get more information about the available transformations type
  ...
  available types of transformations type
...
** KTH graph format
   ...
   Graph must  be given in the  following format: the file  can start
